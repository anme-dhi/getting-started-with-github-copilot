...
activities = {
    ...
    "Soccer Club": {
        "description": "Join our soccer team for fun and fitness",
    ...
    "Art Studio": {
        ...
        "max_participants": 18,
        "participants": ["isabella@mergington.edu", "fiona@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Music Ensemble": {
        "description": "Play instruments and perform in musical groups",
